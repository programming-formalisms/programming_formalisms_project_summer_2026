...
R1.6          |Table column names are documented                                   |Passes the test case  |The documentation contains the names of the columns | P1S2: metadata and col values in data should be aggreable for cross-validation |
